...
public class AccessPermission {
    public enum AccessType {
        NO_ACCESS, CREATE_PR, VIEW_PR, EDIT_PR, APPROVE_PR, VIEW_PO, EDIT_PO
    }
    ...
    static {
        ...
        adminPRAccessMap.put("pending", AccessType.EDIT_PR);
        adminPRAccessMap.put("late", AccessType.EDIT_PR);
        ...
        adminPOAccessMap.put("pending", AccessType.EDIT_PO);
        adminPOAccessMap.put("approved", AccessType.VIEW_PO);
        adminPOAccessMap.put("verified", AccessType.VIEW_PO);
        ...
        inventoryPOAccessMap.put("pending", AccessType.EDIT_PO);
        inventoryPOAccessMap.put("approved", AccessType.VIEW_PO);
        ...
        financePOAccessMap.put("pending", AccessType.EDIT_PO);
